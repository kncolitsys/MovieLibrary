...
lightWindow.prototype = {
	...
	initialize : function(options) {
		this.options = Object.extend({
			...
			fileTypes : {
				page : ['htm', 'html', 'rhtml', 'phtml', 'txt', 'php', 'shtml', 'php4', 'php3', 'php', 'php5', 'asp', 'aspx', 'vbs', 'pl', 'cgi', 'rb', 'cfm'],
	...
	activate : function(e, link){
		...
		var contentType = this.getParam('lWContentType', this.element.params);
		if (contentType) {
			this.contentToFetch = link.href;
			this.windowType = contentType;
		}
		else {
	...
	deactivate : function(){
		...
		this.onClosing(this.options.onClosingCallFunction);
	...
	onClosing : function(f) {
		if (this.options.onClosingCallFunction != null) f();
	},
	//
