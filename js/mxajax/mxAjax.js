...
function include(jsFileName) {
	var file = '<' + 'script src="' + jsFileName + '" language="javascript" type="text/javascript"' + '>' + '<' + '/script' + '>';
	document.write(file);
}
...
include(jsPath + "mxajax/mxParam.js");
include(jsPath + "mxajax/json.js");
include(jsPath + "mxajax/mxParser.js");
include(jsPath + "mxajax/DP_Debug.js");
